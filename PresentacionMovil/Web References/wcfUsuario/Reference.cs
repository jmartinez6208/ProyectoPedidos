...
namespace PresentacionMovil.wcfUsuario {
    ...
    public partial class UsuarioWCF : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback DevolverUsuarioPorIdOperationCompleted;
        ...
        /// <remarks/>
        public event DevolverUsuarioPorIdCompletedEventHandler DevolverUsuarioPorIdCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/IUsuarioWCF/DevolverUsuarioPorId", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public UsuarioEntidades DevolverUsuarioPorId(int identificador, [System.Xml.Serialization.XmlIgnoreAttribute()] bool identificadorSpecified) {
            object[] results = this.Invoke("DevolverUsuarioPorId", new object[] {
                        identificador,
        ...
        /// <remarks/>
        public void DevolverUsuarioPorIdAsync(int identificador, bool identificadorSpecified) {
            this.DevolverUsuarioPorIdAsync(identificador, identificadorSpecified, null);
        }
        
        /// <remarks/>
        public void DevolverUsuarioPorIdAsync(int identificador, bool identificadorSpecified, object userState) {
            if ((this.DevolverUsuarioPorIdOperationCompleted == null)) {
                this.DevolverUsuarioPorIdOperationCompleted = new System.Threading.SendOrPostCallback(this.OnDevolverUsuarioPorIdOperationCompleted);
            }
            this.InvokeAsync("DevolverUsuarioPorId", new object[] {
                        identificador,
                        identificadorSpecified}, this.DevolverUsuarioPorIdOperationCompleted, userState);
        }
        
        private void OnDevolverUsuarioPorIdOperationCompleted(object arg) {
            if ((this.DevolverUsuarioPorIdCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.DevolverUsuarioPorIdCompleted(this, new DevolverUsuarioPorIdCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4161.0")]
    public delegate void DevolverUsuarioPorIdCompletedEventHandler(object sender, DevolverUsuarioPorIdCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4161.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class DevolverUsuarioPorIdCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal DevolverUsuarioPorIdCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
