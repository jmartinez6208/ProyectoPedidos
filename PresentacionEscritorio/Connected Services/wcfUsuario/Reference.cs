...
namespace PresentacionEscritorio.wcfUsuario {
    ...
    public interface IUsuarioWCF {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IUsuarioWCF/DevolverListaClientes", ReplyAction="http://tempuri.org/IUsuarioWCF/DevolverListaClientesResponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(PresentacionEscritorio.wcfUsuario.UsuarioWCF), Action="http://tempuri.org/IUsuarioWCF/DevolverListaClientesUsuarioWCFFault", Name="UsuarioWCF", Namespace="http://schemas.datacontract.org/2004/07/ServiciosWCF")]
        PresentacionEscritorio.wcfUsuario.UsuarioEntidades[] DevolverListaClientes();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IUsuarioWCF/DevolverListaClientes", ReplyAction="http://tempuri.org/IUsuarioWCF/DevolverListaClientesResponse")]
        System.Threading.Tasks.Task<PresentacionEscritorio.wcfUsuario.UsuarioEntidades[]> DevolverListaClientesAsync();
    }
    ...
    public partial class UsuarioWCFClient : System.ServiceModel.ClientBase<PresentacionEscritorio.wcfUsuario.IUsuarioWCF>, PresentacionEscritorio.wcfUsuario.IUsuarioWCF {
        ...
        public PresentacionEscritorio.wcfUsuario.UsuarioEntidades[] DevolverListaClientes() {
            return base.Channel.DevolverListaClientes();
        }
        
        public System.Threading.Tasks.Task<PresentacionEscritorio.wcfUsuario.UsuarioEntidades[]> DevolverListaClientesAsync() {
            return base.Channel.DevolverListaClientesAsync();
        }
    }
}
